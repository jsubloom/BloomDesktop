...
namespace Bloom.ErrorReporter
{
	...
	public class HtmlErrorReporter: IErrorReporter, IBloomErrorReporter
	{
		...
		/// <summary>
		/// Notifies the user of a problem, using a browser-based dialog.
		/// Allows customization of the "Report" button as well as an optional extra button.
		/// </summary>
		...
		/// <param name="shouldHideReportButton">Set to true to hide the Report button. Default is false.</param>
		/// <param name="onReportButtonClicked">The action to take when the report button is clicked. null means default, which is to pop up a NonFatal Problem Report dialog.</param>
		/// <param name="extraButtonLabel">The label of the extra button. "" means disabled. null means default, which is disabled.</param>
		...
		public void NotifyUserOfProblemCustom(string message, Exception exception = null, IRepeatNoticePolicy policy = null,
			bool shouldHideReportButton = false,
			string extraButtonLabel = null, Action<string, Exception> onExtraButtonClicked = null)
		{
			string reportButtonLabel = shouldHideReportButton ? "" : DefaultReportLabel;
			NotifyUserOfProblemInternal(message, exception, policy, reportButtonLabel, DefaultOnReportClicked, extraButtonLabel, onExtraButtonClicked);
		}
