...
namespace BloomTests.Book
{
	...
	public class BookTests : BookTestsBase
	{
		...
		[Test]
		public void GetPreviewHtmlFileForWholeBook_BookHasVideo_PreviewKeepsVideo()
		{
			...
			// Verification
			AssertThatXmlIn.Dom(result.RawDom.StripXHtmlNameSpace()).HasSpecifiedNumberOfMatchesForXpath("//video", 1);
		}
